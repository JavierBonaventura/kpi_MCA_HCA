...
function VinosComponente10() {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row bg-[#252323] overflow-hidden">
      <div
        data-aos="fade-right"
      ...
      >
        <h1
          className="text-white text-2xl lg:text-[2rem] lg:leading-[50px] uppercase"
          style={gothamBlack}
        >
          Single Vineyard
        </h1>
        ...
        <div>
          <p className="mt-6 lg:mt-0 font-gotham text-white text-base lg:text-lg">
            ...
            de terruños y expresiones que nos regala el Valle de Uco. Nuestra
            apuesta por la calidad se refleja en el Malbec que adopta distintos
            perfiles en tres de nuestros viñedos más emblemáticos: Gualtallary,
            Vista Flores y Pampa el Cepillo.
          </p>
