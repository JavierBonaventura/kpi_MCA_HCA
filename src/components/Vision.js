...
function Vision() {
  return (
    <div className="w-full h-[624px] bg-cover bg-[#252323] flex justify-center">
      <div
        className="text-center relative z-10 top-[120px]  ml-32"
        id="izquierdo"
      >
        ...
        <div className="boton-ver-mas-vision mt-16 border-white relative  flex flex-col items-center hover:bg-[#460377] hover:cursor-pointer rounded">
