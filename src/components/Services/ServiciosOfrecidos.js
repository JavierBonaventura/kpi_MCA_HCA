...
function ServiciosOfrecidos() {
    ...
    <div>
      <div className="w-full h-[1745px] relative">
        ...
        >
          ...
          >
            Enter dark mode. Oft referred to as night mode, high contrast, or inverted colors, the setting has grown popular with those who claim to experience eye fatigue from a deluge of white.
          </div>
                ...
                {hoveredIndex === index && (
                  <div
                    style={{
                      ...
                      width: "361.768px",
                      height: "5px",
                      background: "linear-gradient(0deg, #00942C 0%, #00942C 100%), #00942C",
  ...
  <div className="absolute z-0 w-full">
    <img
      ...
      style={{ width: "100vw", height: "678px", objectFit: "cover" }} // Asegúrate de que la imagen cubra el contenedor sin deformarse
    />
  </div>
  ...
  <div
    ...
    style={{
      ...
      flexShrink: 0,
      background: "linear-gradient(90deg, #dfe8e0 0%, rgba(237, 242, 232, 0.00) 100%)",
      top: "0%",
      left: "100%",
  ...
  <div className="flex mt-24 mx-auto" style={{ width: "1074px", gap: "100px", position: 'relative', zIndex: 10 }}>
    {/* Columna izquierda */}
  ...
  <div className="absolute z-10 w-full" style={{ top: "300px", position: 'relative' }}>
