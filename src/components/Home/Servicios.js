      ...
      <div className="w-full h-[852px]">
        ...
        >
          ...
          <div>
            ...
            <div className="relative mt-[120px] h-[76px]">
              <div
                className="absolute left-1/2 transform -translate-x-[220%]"
                style={{
                  color: "#000",
            ...
            <div className="relative mt-[15px] h-[70px]">
              <div
                className="absolute left-1/2 transform -translate-x-[75%] w-[711px]"
                style={{
                  color: "#000",
                  fontFamily: "Fira Sans",
                  fontSize: "18px",
